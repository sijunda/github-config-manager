...
This project uses [GCM](https://github.com/justjundana/github-config-manager)
for Git identity management.

### First-Time Setup

1. Install GCM: `go install github.com/justjundana/github-config-manager/cmd/gcm@latest`
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Install GCM
        run: go install github.com/justjundana/github-config-manager/cmd/gcm@latest
...
1. Install: go install github.com/justjundana/github-config-manager/cmd/gcm@latest
